...
export default function ProfileForm({
  ...
  const copy = language === "ja"
    ? {
        ...
        monsterDescription: "プロフィールに表示する内容です。一つの欄には、一つのことを短い言葉で入力してください。",
    ...
    : {
        ...
        monsterDescription: "These details are shown on your profile. Add one short thing in each field.",
