...
func TestPostgresMigrationCreatesAuthTables(t *testing.T) {
	...
	for _, want := range []string{"sessions", "photos", "profiles", "user_locations", "recruitment_cards", "blocks", "matches", "match_likes", "chat_threads", "messages", "chat_read_states", "meeting_sessions", "meeting_proximity_latest", "chat_key_manifests", "chat_translation_rate_limits", "chat_translation_inflight"} {
