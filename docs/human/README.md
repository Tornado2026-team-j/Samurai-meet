...
読む順番は、[全体像](overview.md) → [ログイン](auth-and-login.md) → [フロントエンド接続](frontend-connection.md) → [安全性と残作業](security-and-roadmap.md) です。ハッカソン発表で審査員に触ってもらう準備は [審査員向けリモートテストキット](remote-test-kit.md) を使います。
